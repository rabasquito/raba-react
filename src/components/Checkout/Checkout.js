...
export const Checkout = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        productos.docs.forEach((doc) => {
            ...
            if (doc.data().disponible >= itemToUpdate.counter) {
                batch.update(doc.ref, {
                    stock: doc.data().disponible - itemToUpdate.counter
                })
            } else {
                ...
                <div className="container my-5">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input
                            ...
                            placeholder="email"
                        />
                        {values.emailConfirm.length !== values.email.length && <small>Los email no coinciden </small>}
